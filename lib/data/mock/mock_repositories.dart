...
class MockActivityRepository implements ActivityRepository {
  ...
  @override Future<Activity> create({required String title, required ActivityKind kind, required bool startNow, required ParticipationMode participationMode, String? meetingPoint, String? meetingAddress, double? meetingLatitude, double? meetingLongitude, required String routeStartName, required String routeStartAddress, required double routeStartLatitude, required double routeStartLongitude, required String routeDestinationName, required String routeDestinationAddress, required double routeDestinationLatitude, required double routeDestinationLongitude, required ActivityRoutePlan routePlan, List<ActivityRouteStop> routeStops = const [], String? description, String? groupId}) async => store.create(title: title, kind: kind, startNow: startNow, participationMode: participationMode, meetingPoint: meetingPoint, routeStartName: routeStartName, routeDestinationName: routeDestinationName, routePlan: routePlan, routeStops: routeStops, description: description, groupId: groupId);
