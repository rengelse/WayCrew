...
class MockActivityStore extends StateNotifier<List<Activity>> {
  ...
  Activity create({required String title, required ActivityKind kind, required bool startNow, required DateTime startsAt, required ParticipationMode participationMode,
    ...
    final activity = Activity(
      ...
      startsAt: startsAt, maxParticipants: 12, distanceKm: routePlan.distanceKm,
